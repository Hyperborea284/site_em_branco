"""
Django settings for production_2024 project.
...
ROOT_URLCONF = 'production_2024.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'production_2024/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'production_2024.wsgi.application'
...
STATIC_URL = '/static/'  # Isso está correto
STATIC_ROOT = BASE_DIR / 'staticfiles'

# Configurações de arquivos de mídia
MEDIA_URL = '/media/'  # Isso está correto
